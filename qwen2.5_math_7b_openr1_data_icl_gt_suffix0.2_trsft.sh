...
SAVE_DIR=/data/langlin/Checkpoints/qwen2.5_math_7b_openr1_data_icl_gt_suffix0.2_trsft
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2.5_math_7b_openr1_data_icl_gt_suffix0.2_trsft \
    ...
    worker.rollout.n=8 \
    data.apply_icl=true \
    data.icl_examples_path="examples/case_examples_openmathreasoning.jsonl" \
    ...
    algorithm.suffix_is_ratio_lower_bound=0.2 \
    algorithm.prefix_loss_type="trsft" \
    algorithm.trsft_alpha=0.1
