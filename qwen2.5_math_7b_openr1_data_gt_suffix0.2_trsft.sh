...
SAVE_DIR=/data/langlin/Checkpoints/qwen2.5_math_7b_openr1_data_gt_suffix0.2_trsft
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2.5_math_7b_openr1_data_gt_suffix0.2_trsft \
