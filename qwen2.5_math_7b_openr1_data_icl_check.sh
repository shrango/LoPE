...
SAVE_DIR=/data/langlin/Checkpoints/qwen2.5_math_7b_simple_prompt_openr1_data_incontext_instruction_and_case_check
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2.5_math_7b_simple_prompt_openr1_data_incontext_instruction_and_case_check \
