...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-4b-base_openr1_data_bs128_naive_fallback_test_MATH_wokl
...
python3 -m verl.trainer.main \
    ...
    trainer.project_name="easy_r1_qwen3_4b-base" \
    trainer.experiment_name=qwen3-4b-base_openr1_data_bs128_naive_fallback_test_MATH_wokl \
    trainer.save_checkpoint_path=$SAVE_DIR \
    worker.rollout.n=8 \
    algorithm.use_kl_loss=false \
    algorithm.disable_kl=true \
    algorithm.kl_coef=0.0 \
    algorithm.fallback_with_original_prompt=true \
    data.apply_icl=true \
