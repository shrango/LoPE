...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-1.7b-base_openr1_data_bs128_icl_instruction_case_test_MATH_check
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3-1.7b-base_openr1_data_bs128_icl_instruction_case_test_MATH_check \
