...
class DataParallelPPOActor(BasePPOActor):
    ...
    def update_policy(self, data: DataProto) -> dict[str, Any]:
        ...
        # 检查是否有 real_rollout 和 is_ground_truth 标记
        has_real_rollout = "real_rollout" in data.non_tensor_batch
        has_is_ground_truth = "is_ground_truth" in data.non_tensor_batch
        
        if has_real_rollout:
            non_tensor_select_keys.append("real_rollout")
        if has_is_ground_truth:
            non_tensor_select_keys.append("is_ground_truth")
        ...
        for _ in range(self.config.ppo_epochs):
            ...
            for mini_batch in mini_batches:
                ...
                global_sample_offset += len(mini_batch)
