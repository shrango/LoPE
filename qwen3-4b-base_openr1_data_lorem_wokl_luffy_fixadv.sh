...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-4b-base_openr1_data_bs128_lorem_test_MATH_wokl_luffy_fixadv
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3-4b-base_openr1_data_bs128_lorem_test_MATH_wokl_luffy_fixadv \
