...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-1.7b-base_openr1_data_bs128_lorem_test_MATH_wokl_luffy_short_20
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3-1.7b-base_openr1_data_bs128_lorem_test_MATH_wokl_luffy_short_20 \
    ...
    data.lorem_word_min=20 \
    data.lorem_word_max=20 \
    trainer.save_freq=5 \
