...
SAVE_DIR=/data/langlin/Checkpoints/qwen2.5_math_7b_openr1_data_icl_gt_standard
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen2.5_math_7b_openr1_data_icl_gt_standard \
    ...
    algorithm.use_safe_policy_loss=false
