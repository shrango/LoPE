...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-1.7b-base_openr1_data_bs128_random_ascii
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3-1.7b-base_openr1_data_bs128_random_ascii \
    ...
    data.use_random_ascii=true \
    data.use_random_token=false \
    data.use_lorem=false \
    data.use_fake_sentence=false \
