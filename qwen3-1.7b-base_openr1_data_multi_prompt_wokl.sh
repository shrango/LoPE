...
SAVE_DIR=/data/langlin/Checkpoints/qwen3-1.7b-base_openr1_data_bs128_multi_style_templates_test_MATH_wokl
...
python3 -m verl.trainer.main \
    ...
    trainer.experiment_name=qwen3-1.7b-base_openr1_data_bs128_multi_style_templates_test_MATH_wokl \
    ...
    data.multi_style_templates=true \
    data.icl_rollout_n=2 \
    trainer.save_freq=5 \
